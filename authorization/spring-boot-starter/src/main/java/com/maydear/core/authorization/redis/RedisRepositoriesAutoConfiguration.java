...
@ConditionalOnProperty(prefix = "tubsoft.authorization.accesstoken.redis.repositories", name = "enabled", havingValue = "true",
        matchIfMissing = true)
@ConditionalOnMissingBean(RedisRepositoryFactoryBean.class)
@Import(RedisRepositoriesRegistrar.class)
@AutoConfigureAfter(RedisTicketStoreAutoConfiguration.class)
