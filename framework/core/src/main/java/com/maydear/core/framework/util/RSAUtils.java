...
public class RSAUtils {
     ...
     * RSA加密
     * @param data 待加密数据
     * @param publicKeyString 公钥内容
     * @return 返回BASE64编码密文
     * @throws Exception
     */
    public static String encrypt(final String data, final String publicKeyString) throws Exception {
     ...
     * @throws Exception
     */
    public static String decrypt(final String data,final String privateKeyString) throws Exception{
